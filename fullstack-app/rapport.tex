...
\begin{titlepage}
    ...
    {\large Faculté des Sciences et Techniques}\\[2cm]
...
Je tiens à exprimer mes sincères remerciements à mon professeur, \textbf{Pr. [Nom]}, pour son encadrement, ses conseils précieux et son soutien tout au long de ce projet. Ses orientations m'ont permis d'approfondir mes connaissances en sécurité des applications web modernes.
